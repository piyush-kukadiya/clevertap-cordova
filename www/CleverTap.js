...
CleverTap.prototype.setOptOut = function (userOptOut, allowSystemEvents) {
    const finalAllowSystemEvents = typeof allowSystemEvents === 'undefined' ? !userOptOut : allowSystemEvents;
    cordova.exec(null, null, "CleverTapPlugin", "setOptOut", [userOptOut, finalAllowSystemEvents]);
}
...
CleverTap.prototype.registerPushToken = function (token, pushType) {
    cordova.exec(null, null, "CleverTapPlugin", "registerTokenAsString", [token, pushType]);
}
